...
Every evidenceUsed item must reference a supplied field with source lead, audit, signal, or screenshot. Valid field names are the ones present in the input. For screenshot, use field homepage.`;
}
